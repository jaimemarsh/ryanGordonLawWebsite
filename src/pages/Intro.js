    ...
    return (
        <div>
            <div className="container has-text-centered mt-6">
                ...
                <p className="google-font-ss is-size-2 is-size-5-mobile">Our services include:
                <ul>
                    <li><Link to="/Estate"> Estate Planning</Link>,<Link to="/Trust"> Estate and Trust Administration</Link>,</li>
                   <li> <Link to="/Probate"> Probate Fiduciary and Commerical Litigation</Link>,</li>
                   <li> <Link to="/Mal"> Attorney Malpractice Litigation</Link>,<Link to="/Business"> Business Law</Link>,</li>
                   <li><Link to="/RealEstate"> Real Estate Law</Link>, and <Link to="/Tax"> Tax Law</Link>.</li>
                    </ul> </p>
            </div>
            <div className="is-size-2 has-text-centered google-font-pd is-size-4-mobile m-4">
                ...
                <div className="mt-3"><Link to="/"><FontAwesomeIcon icon={faStar} size="sm" className="is-size-3 mr-4" />Leave a Review</Link></div>
            </div>
        </div >
    );
};
